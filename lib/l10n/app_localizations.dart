...
abstract class AppLocalizations {
  ...
  /// No description provided for @breedDetailTitle.
  ///
  /// In en, this message translates to:
  /// **'Breed Detail'**
  String get breedDetailTitle;
  ...
  /// No description provided for @noBreeds.
  ///
  /// In en, this message translates to:
  /// **'No breeds found'**
  String get noBreeds;
  ...
  /// No description provided for @breedImage.
  ///
  /// In en, this message translates to:
  /// **'{name} image'**
  String breedImage(Object name);

  /// No description provided for @breedDetails.
  ///
  /// In en, this message translates to:
  /// **'{name} details'**
  ...
  /// Semantics label for breed card
  ///
  /// In en, this message translates to:
  /// **'Cat breed: {name}'**
